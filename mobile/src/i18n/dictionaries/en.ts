...
export const en = {
  ...
  childForm: {
    ...
    animalsHint: 'Cats, dinosaurs, owls…',
    ...
    colourClay: 'Clay',
    colourInk: 'Ink',
    editTitle: 'Edit {name}’s profile',
    remove: 'Remove profile',
    removeConfirm: 'Stories already made will be kept.',
  ...
  reader: {
    ...
    stageWriting: 'Writing the story',
    stagePainting: 'Painting the pictures',
    stageRecording: 'Recording the narration',
    stageAlmost: 'The story is written',
